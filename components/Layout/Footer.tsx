...
const Footer = () => {
  return (
    <div className="min-h-[230px] border-t-[1px] border-zinc-200 dark:border-zinc-800">
      <div className="flex flex-col-reverse md:flex-row justify-between w-[90%] mx-auto py-5 md:py-10">
        <div className="mt-10 md:mt-0 flex flex-col min-h-[80px] md:min-h-[180px]">
          ...
          <p className="font-normal text-base text-zinc-600 dark:text-zinc-200">
            Software Engineer
          </p>
          <p className="mb-4 md:mt-2 font-normal text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="min-h-[150px] flex flex-col-reverse md:flex-row flex-grow">
          ...
          <div className="max-w-[350px] mr-[10vw]">
            ...
            <div className="flex flex-wrap md:block justify-start">
              <a
                href="#"
                className="block min-w-[120px] text-gray-700 hover:text-black dark:text-gray-400 dark:hover:text-white text-sm mt-1 "
              >
                Github
              </a>
              <a
          ...
          <div className="max-w-[350px]">
            <p className="text-gray-900 dark:text-gray-50 font-bold">
            ...
            <div className="flex mt-3">
              <input
                type="text"
                className="bg-transparent text-sm font-semibold outline-none border-zinc-600 border-2 rounded-md p-2 dark:text-white"
              />
              <button className="ml-3 bg-zinc-900 dark:bg-zinc-800 hover:bg-zinc-900 text-white font-extrabold text-sm py-3 px-4 rounded-md">
                Subscribe
              </button>
            </div>
