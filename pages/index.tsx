...
const Home: NextPage = () => {
  return (
    <div className="dark flex min-h-screen flex-col items-center justify-center">
      ...
      <main className=" bg-black text-white flex flex-col justify-center w-full min-h-[100vh] px-[20%]">
        <div className="flex flex-grow items-center justify-center">
          <div className=" hidden lg:block basis-[80px] h-full text-white border-r">
            <svg
          ...
          <div className="pl-0 md:pl-10 w-[90vw] mx-auto md:w-auto">
            <h1 className="mx-auto text-center text-5xl md:text-6xl lg:text-7xl font-[900] font-body whitespace-nowrap">
              Hy i'm LeulAria
              <br />
              Software Engineer!
            </h1>

            <p className="text-center mt-3 text-sm md:text-xl mx-auto max-w-[550px] text-zinc-300">
            ...
            <div className="flex justify-center mt-10 mx-auto">
              <div className="overflow-hidden rounded-[2rem] mx-2">
                <Ripple color="#ddd">
                  <button className="overflow-hidden px-10 py-2 md:px-16 md:py-3 bg-indigo-700 text-white rounded-[3rem]">
                    Contact
                  </button>
                </Ripple>
              </div>
              <div className="overflow-hidden rounded-[2rem] mx-2">
                <Ripple color="#ddd">
                  <button className="overflow-hidden px-10 py-2 md:px-16 md:py-3 bg-[#333] text-white rounded-[3rem]">
                    Resume
                  </button>
                </Ripple>
              </div>
